...
export default function NewProductionPage() {
  ...
  const [productionMaterials, setProductionMaterials] = useState<ProductionMaterial[]>([{ materialId: '', quantity: '' }]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const productionId = await createProduction({ ...productionData, userId });
