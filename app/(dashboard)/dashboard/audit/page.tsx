...
export default function AuditLogPage() {
  const rawAuditLogs = useQuery(api.audit.getAuditLogs);
  ...
  const uniqueActionTypes = useMemo(() => {
    ...
    auditLogs.forEach((log) => types.add(log.actionType as AuditLog['actionType']));
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <div className="flex flex-col md:flex-row gap-4">
            <Input placeholder="Search by action, entity, or value..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="flex-grow" />
