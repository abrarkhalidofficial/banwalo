...
export default function ClientDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const clientId = use(params).id as Id<'clients'>;
    ...
    return (
      <div className="p-6">
        <div className="flex items-center mb-8">
          <Button variant="ghost" className="mr-4" onClick={() => router.push('/dashboard/clients')}>
          ...
          <CardHeader>
            <CardTitle className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <Button size="sm" variant="ghost" onClick={() => router.push(`/dashboard/clients/${clientId}/edit`)}>
                ...
                <AlertDialog open={isConfirmDialogOpen} onOpenChange={setIsConfirmDialogOpen}>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>This action cannot be undone. This will permanently delete the client and remove all associated data from our servers.</AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            <TableBody>
              {productions.length === 0 ? (
                ...
                productions.map((production) => (
                  <TableRow key={production._id.toString()} className="cursor-pointer hover:bg-muted/50" onClick={() => router.push(`/dashboard/production/${production._id}`)}>
                    ...
                    <TableCell>PKR {production.clientPrice}</TableCell>
                  </TableRow>
                ))
              )}
            </TableBody>
