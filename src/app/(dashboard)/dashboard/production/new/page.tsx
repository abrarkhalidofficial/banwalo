...
export default function NewProductionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate materials
    const validMaterials = productionMaterials.filter(
      (m) => m.materialId && m.quantity && parseFloat(m.quantity) > 0
    );
    ...
    try {
      ...
      // Only include solidPieces if it has a value
      if (solidPieces && parseInt(solidPieces) > 0) {
        productionData.solidPieces = parseInt(solidPieces);
      }

      // Only include optional costs if they have values
      ...
      const productionId = await createProduction(productionData);
        ...
        <Tabs defaultValue="basic" className="w-full">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="articleName">Article Name <span className="text-red-500">*</span></Label>
                    <Input
                      id="articleName"
                      value={articleName}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="totalPieces">Total Number of Pieces <span className="text-red-500">*</span></Label>
                    <Input
                      id="totalPieces"
                      type="number"
                      min="1"
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min="0"
                      value={solidPieces}
                      onChange={(e) => setSolidPieces(e.target.value)}
                      placeholder="Enter solid pieces"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <DatePicker
                      selected={stitchingDate}
                      onSelect={setStitchingDate}
                      placeholder="Select stitching date"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min="0"
                      step="0.01"
                      value={overlockedShirtCost}
                      onChange={(e) => setOverlockedShirtCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min="0"
                      step="0.01"
                      value={overlockedTrouserCost}
                      onChange={(e) => setOverlockedTrouserCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      step="0.01"
                      value={flatShirtCost}
                      onChange={(e) => setFlatShirtCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min="0"
                      step="0.01"
                      value={flatTrouserCost}
                      onChange={(e) => setFlatTrouserCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min="0"
                      step="0.01"
                      value={singleShirtCost}
                      onChange={(e) => setSingleShirtCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min="0"
                      step="0.01"
                      value={singleTrouserCost}
                      onChange={(e) => setSingleTrouserCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      step="0.01"
                      value={threadingCost}
                      onChange={(e) => setThreadingCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                </div>
                  ...
                  {productionMaterials.map((material, index) => (
                    <div key={index} className="flex items-end gap-4">
                      ...
                      <Button
                        ...
                        disabled={productionMaterials.length === 1}
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      step="0.01"
                      value={pocketZipCost}
                      onChange={(e) => setPocketZipCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      step="0.01"
                      value={doryCost}
                      onChange={(e) => setDoryCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      step="0.01"
                      value={fullZipCost}
                      onChange={(e) => setFullZipCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      step="0.01"
                      value={elasticCost}
                      onChange={(e) => setElasticCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min="0"
                      step="0.01"
                      value={packingZipperCost}
                      onChange={(e) => setPackingZipperCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min="0"
                      step="0.01"
                      value={packingShopperCost}
                      onChange={(e) => setPackingShopperCost(e.target.value)}
                      placeholder="0.00"
                    />
                  </div>
          ...
          <TabsContent value="pricing">
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <Label htmlFor="clientPrice">Client Price (per piece) <span className="text-red-500">*</span></Label>
                  <Input
                    id="clientPrice"
                    type="number"
                    min="0"
