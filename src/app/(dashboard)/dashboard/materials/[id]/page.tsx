...
import { ArrowLeft, AlertTriangle, Edit, Package as PackageIcon, Trash } from "lucide-react";
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  and all associated stock entries and usage history.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
            ...
            <dl className="divide-y divide-gray-200">
              ...
              <div className="py-3 grid grid-cols-3">
                ...
                <dd className="text-sm text-gray-900 col-span-2">
                  {material.lowStockThreshold ? `${material.lowStockThreshold} units` : "Not set"}
                </dd>
              </div>
              <div className="py-3 grid grid-cols-3">
            ...
            <TableBody>
              {usageHistory.length === 0 ? (
                ...
                usageHistory.map((usage) => (
                  <TableRow 
                    key={usage.productionId} 
                    className="cursor-pointer hover:bg-muted/50"
                    onClick={() => router.push(`/dashboard/production/${usage.productionId}`)}
                  >
                    ...
                    <TableCell>₹{(usage.averageCost || 0).toFixed(2)}/unit</TableCell>
                    <TableCell>₹{(usage.totalCost || 0).toFixed(2)}</TableCell>
                  </TableRow>
                ))
              )}
            </TableBody>
